...
projects:"Projekt",category:"Kategoria",allitems:"Wszystkie",lowprice:"Cena malej\u0105co",hightprice:"Cena rosn\u0105co",iagree:"Zgadzam si\u0119 na",terms:"warunki u\u017cytkowania"}};window.addEventListener("load",function(){window.language=new w})})();(function(){function w(a){a=a.getElementsByTagName("*");for(var d={},b=0;b<a.length;++b)if(a[b].hasAttribute("user-input")){var c=a[b].getAttribute("user-input");a[b].controller?d[c]=a[b].controller.value():a[b].value?d[c]=a[b].value:a[b].firstChild&&3==a[b].firstChild.nodeType&&a[b].firstChild.nodeValue&&(d[c]=a[b].firstChild.nodeValue)}return d}function D(a,d){d=d||"";if("INPUT"==a.nodeName)a.value=d;else if("DIV"==a.nodeName)if(a.controller)a.controller.setValue(d);else if(a.firstChild&&3==a.firstChild.nodeType&&
